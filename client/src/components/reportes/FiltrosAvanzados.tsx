  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6 mb-8">
      ...
      <div className="space-y-3 mb-4">
        ...
        {/* Mobile Layout - Segunda fila */}
        <div className="md:hidden grid grid-cols-2 gap-2">
          {(['trimestre', 'año'] as const).map((preset) => (
            <Button
              key={preset}
              variant={filtros.periodoPreset === preset ? 'primary' : 'outline'}
              size="sm"
      ...
      {mostrarFiltros && (
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          ...
          <div className="mb-6">
            {/* Desktop Layout */}
            <div className="hidden md:flex items-center gap-1 bg-gray-50 dark:bg-gray-700 rounded-lg p-1">
              {[
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <button
                    key={key}
                    onClick={() => setSeccionActiva(key as any)}
                    className={`flex items-center justify-center gap-2 px-3 py-2 rounded-md text-xs font-medium transition-colors ${
                      seccionActiva === key
